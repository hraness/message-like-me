...
desktop coordinate is `desktop-v0.1.3-macos-arm64`, with assets
`Textbutler-0.1.3-macos-arm64.zip`, `desktop-manifest.json`, `SHA256SUMS`, and
...
tag `desktop-v0.1.3-macos-arm64` at that exact commit. Dispatch the workflow from
