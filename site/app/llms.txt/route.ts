...
export function GET() {
  const body = [
    ...
    'Replies require a configured Ghostget connection, a ready explicit agent account, an enabled contact, and global resume. Claude API is the current separately billed option in the packaged runtime; native Claude Code and Codex remain unavailable. There is no windowed Textbutler app download; releases ship the CLI and prebuilt menu companion. Live delivery still needs verification on the selected account.',
